...
from routes.admin import (
    ...
    update_shift_type_rate, update_shift_segment, save_all_segments_history_for_month
)
...
@app.put("/api/shift-types/{shift_type_id}/rate")
async def update_shift_type_rate_route(request: Request, shift_type_id: int):
    """Update shift type rate with history support."""
    return await update_shift_type_rate(request, shift_type_id)
